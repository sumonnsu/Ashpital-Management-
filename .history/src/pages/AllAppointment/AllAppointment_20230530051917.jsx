            ...
            <div className='grid grid-cols-2 w-3/4 mx-auto mt-10 mb-10 gap-5'>
                ...
                } */}
                {
                    appointments.map(appointment => <div key={appointment._id} className='border pl-10 shadow-xl py-10 '>
                        <p>Age: {appointmentage}</p>
                        <p>Problem: {appointmentsymbol}</p>
                        <p>Suffering Time: {appointmentduration}</p>
                        <p>Appointed Doctor: {appointmentdoctorName}</p>
                        <button onClick={() => handleDelete(appointment_id)} className='btn btn-outline btn- mt-5'>Delete</button>
                    </div>)
                }
            </div>
        </div>
